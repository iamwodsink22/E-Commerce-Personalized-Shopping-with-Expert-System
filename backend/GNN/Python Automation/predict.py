...
df = pd.read_csv('D:/Ecommerce/backend/GNN/Python Automation/Product_Users_ratings.csv', sep=',', encoding='latin-1')
users = pd.read_csv('D:/Ecommerce/backend/GNN/Python Automation/Users.csv', sep=',', encoding='latin-1')
products = pd.read_csv('D:/Ecommerce/backend/GNN/Python Automation/Completed.csv', sep=',', encoding='latin-1', on_bad_lines='skip')
# Preprocessing
...
productid_title = pd.Series(products['product_name'].values, index=products['product_id']).to_dict()
productid_author = pd.Series(products['categories'].values, index=products['product_id']).to_dict()
...
def predict_recs():
    ...
    recs_df.to_csv("D:/Ecommerce/backend/GNN/Python Automation/recs.csv",index=False)
    df=pd.read_csv("D:/Ecommerce/backend/GNN/Python Automation/recs.csv")
