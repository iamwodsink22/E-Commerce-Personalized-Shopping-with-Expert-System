...
pf = pd.read_csv('./res/Product_Users_Ratings.csv', sep=',', encoding='latin-1')
users = pd.read_csv('./res/Users.csv', sep=',', encoding='latin-1')
products = pd.read_csv('./res/amazon-products.csv', sep=',', encoding='latin-1', on_bad_lines='skip')
...
df_data=pd.read_csv('./res/amazon-products2.csv')
