...
const handleView=(id:number)=>{
  ...
  return (
    <Box>
      <img style={{height:'25vw',width:'100%'}}src={'https://i.pinimg.com/originals/9a/71/6f/9a716f90fc2e24079b8960168d5ea089.jpg'}/>
      ...
      <SearchProduct/>
        ...
        {products.slice(0,15).map((item:any,index:number)=>{
            return(
                <Card style={{height:'60vh', width: '22vw', borderRadius:'7px'}} sx={{display:'inline-grid', justifyContent:'center',margin:'1vw',marginBottom:'1vw',height:'27vh',width:'20vw',cursor:'pointer', ':hover':{transform:'scale(1.05)', transition:'1s' }}} onClick={()=>handleView(item.product_id)} >
