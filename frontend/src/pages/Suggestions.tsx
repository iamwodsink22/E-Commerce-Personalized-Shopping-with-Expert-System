...
const Suggestions = ({products}: SuggestionsProps) => {
  return (
    ...
    <Box style={{border:'solid 1px grey', width:'36vw', padding: '3px', borderRadius:'0px 0px 2px 2px', overflowY: 'auto', backgroundColor:'white'
        ...
        {products.map(product => (
            <Box style={{width: '98%', borderBottom:0, padding:'3px', height:'12vh'}} sx={{':hover': {fontStyle:'underlined',color:'grey', transition:'0.6s', transform:'scale(1.01)'}}}>
                ...
                <span style={{fontFamily:'Poppins', width:'99%', alignSelf:'center', paddingRight:'5px', paddingLeft:'1.5vw', marginRight:'30px', color:'black'}}>{product.title}</span>
                <span style={{width:'15%', alignSelf:'center', border: 'solid 0.5px white'}}><img src={product.image} alt=""  style={{height:"40px", left:'0px'}}/></span>
